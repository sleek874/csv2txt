...
Portions Copyright (c) 2014-2021 Adobe Systems Incorporated, with Reserved Font
Name "Source".
Portions Copyright (c) 2012 Google Inc.

The bundled Sarasa Mono TC webfont is converted from the unhinted Regular TTF
in the official v1.0.37 release. It is licensed under the SIL Open Font License,
Version 1.1. See [licenses/Sarasa-Gothic-OFL-1.1.txt](licenses/Sarasa-Gothic-OFL-1.1.txt).
