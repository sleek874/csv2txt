...
export const FIXED_FIELDS: readonly FixedFieldDefinition[] = [
  ...
  { index: 5, widthBytes: 10, pattern: /^[a-z0-9]{5,10}$/iu, formatErrorMessage: "請輸入 5 至 10 個英文字母或數字。", description: "轉大寫；證號無效時警告；有效證號可修正欄位8", hooks: ["optional-id-warning", "field-5-gender-match"] },
  ...
  { index: 7, widthBytes: 12, pattern: /^.+$/u, formatErrorMessage: "請輸入內容。", description: "必填；可安全轉為 BIG-5E", hooks: [] },
  { index: 8, widthBytes: 1, pattern: /^[12]$/u, formatErrorMessage: "只能填 1 或 2。", description: "與有效證號不符時依欄位5修正並警告", hooks: ["field-5-gender-match"] },
  { index: 9, widthBytes: 120, pattern: /^.+$/u, formatErrorMessage: "請輸入內容。", description: "必填；可安全轉為 BIG-5E", hooks: [] },
